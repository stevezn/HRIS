...
Public Class NewEmp
    ...
    Sub loadDataKaryawan()
        ...
        SQLConnection.Open()
        Dim sqlCommand As New MySqlCommand
        sqlCommand.CommandText = "SELECT EmployeeCode, CompanyCode, FullName, Position, PlaceOfBirth, DateOfBirth, Gender, Religion, Address, Email, IdNumber, OfficeLocation, WorkDate, PhoneNumber, Photo, Status, TrainingSampai FROM db_pegawai"
        sqlCommand.Connection = SQLConnection
